...
class TablePage extends Component {
    ...
    onFromTimeChanged = (date, dateString) => {
        console.dir(date);
        this.setState({fromTT: date.unix()});
    }
    onToTimeChanged = (date, dateString) => {
        console.dir(date);
    }
        ...
        return (
            <div>
                <Row gutter={4}>
                    ...
                    <Col span={4}>
                        <label>Start:</label>
                        <DatePicker value={fromTT} onChange={(date, dateString) => {
                            this.setState({fromTT: date});
                        }} />
                    </Col>
                    <Col span={4}>
                        <label>End:</label>
                        <DatePicker value={toTT} onChange={(date, dateString) => {
